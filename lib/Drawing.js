...
class Drawing {
    ...
    _init(node, relationshipNode) {
        ...
        //basic
        this._id = relationshipNode.attributes.Id;
        ...
        this._path = relationshipNode.attributes.Target;
    ...
    image() {
        return new ArgHandler("Drawing.image")
            ...
            .case('string', imagePath => {
                ...
                this._workbook._zip.files[this._path.replace('..', 'xl')]._data = tmpzip.files.i._data;
                return this;
            })
            .handle(arguments);
    }
