...
class Drawing {
    ...
    _init(node, relationshipNode) {
        ...
        this._relationship = new Relationships(relationshipNode);
        this._relationship = this._relationship.findById('rId'+pic.attributes.id);
        if(this._relationship) {
            if(this._relationship.attributes.Type.toString().search('/image')) {
                //basic
                this._id = this._relationship.attributes.id;
                ...
                console.log(this._relationship.attributes.Type)
            }
        }
    ...
    */
    toXml() {
        this._relationshipNode.attributes.Id = this._id;
        this._relationshipNode.attributes.Target = this._path;
