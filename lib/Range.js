...
class Range {
    ...
    formula() {
        ...
        return new ArgHandler("Range.formula")
            .case(() => {
                return this.cell(0, 0).getSharedRefFormula();
            })
            .case('string', formula => {
    ...
    merged(merged) {
        ...
        if (arguments.length) {
            ...
            else this.sheet().unmergeCells(this.address());
            return this;
        }
