...
class _Style {
    ...
    _set_fontColor(color) {
        ...
        else if (color >= 0) theme = color;

        jq.set(this._fontNode, {
            "color[0].$.rgb": rgb,
            "color[0].$.indexed": null,
            "color[0].$.theme": theme
        });
    ...
    _set_fontTint(tint) {
        ...
        if (jq.isEmpty(this._fontNode, "color[0].$")) delete this._fontNode.alignment;
    }
    ...
    _get_fill() {
        const patternType = jq.get(this._fillNode, "patternFill[0].$.patternType");
        if (patternType === "solid") {
            return {
                type: "solid",
                color: this._getColor(this._fillNode, "patternFill[0].fgColor[0].$"),
                tint: jq.get(this._fillNode, "patternFill[0].fgColor[0].$.tint")
            };
        } else if (patternType) {
            return {
                type: "pattern",
                ...
                background: {
                    color: this._getColor(this._fillNode, "patternFill[0].bgColor[0].$"),
                    tint: jq.get(this._fillNode, "patternFill[0].bgColor[0].$.tint")
                }
            };
        } else if (this._fillNode.gradientFill) {
            return {
                type: "gradient",
                gradientType: jq.get(this._fillNode, "gradientFill[0].$.type") || "linear",
                angle: jq.get(this._fillNode, "gradientFill[0].$.degree"),
                left: jq.get(this._fillNode, "gradientFill[0].$.left"),
                right: jq.get(this._fillNode, "gradientFill[0].$.right"),
                top: jq.get(this._fillNode, "gradientFill[0].$.top"),
                bottom: jq.get(this._fillNode, "gradientFill[0].$.bottom"),
                stops: _.map(this._fillNode.gradientFill[0].stop, stop => ({
    ...
    _set_fill(fill) {
        if (!_.isObject(fill)) return this._set_fill({
            type: "solid",
            color: fill
        });
        ...
        if (fill.type === "pattern") {
            jq.set(this._fillNode, {
                "patternFill[0].$.patternType": fill.pattern,
                "patternFill[0].fgColor[0].$.rgb": typeof fill.foreground.color === "string" ? fill.foreground.color : undefined,
                "patternFill[0].fgColor[0].$.theme": fill.foreground.color >= 0 ? fill.foreground.color : undefined,
                "patternFill[0].fgColor[0].$.tint": fill.foreground.tint,
                "patternFill[0].bgColor[0].$.rgb": typeof fill.background.color === "string" ? fill.background.color : undefined,
                "patternFill[0].bgColor[0].$.theme": fill.background.color >= 0 ? fill.background.color : undefined,
                "patternFill[0].bgColor[0].$.tint": fill.background.tint
            });
        } else if (fill.type === "gradient") {
            jq.set(this._fillNode, {
                "gradientFill[0].$.type": fill.gradientType === "path" ? "path" : undefined,
                "gradientFill[0].$.left": fill.left,
                "gradientFill[0].$.right": fill.right,
                "gradientFill[0].$.top": fill.top,
                "gradientFill[0].$.bottom": fill.bottom,
                "gradientFill[0].$.degree": fill.angle,
                "gradientFill[0].stop": _.map(fill.stops, stop => ({
                    $: {
                        position: stop.position
                    },
                    color: [jq.set({}, {
                        '$.rgb': typeof stop.color === "string" ? stop.color : undefined,
                        '$.theme': stop.color >= 0 ? stop.color : undefined,
                        '$.tint': stop.tint
                    })]
                }))
            });
            ...
            jq.set(this._fillNode, {
                "patternFill[0].$.patternType": "solid",
                "patternFill[0].fgColor[0].$.rgb": typeof fill.color === "string" ? fill.color : undefined,
                "patternFill[0].fgColor[0].$.theme": fill.color >= 0 ? fill.color : undefined,
                "patternFill[0].fgColor[0].$.tint": fill.tint
            });
        }
    }
}
