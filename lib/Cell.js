 ...
 * @constructor
 */
var Cell = function (sheet, row, columnNumber, cellNode) {
    this._sheet = sheet;
    this._row = row;
...
Cell.prototype.getAddress = function () {
    return utils.rowAndColumnToAddress(this.getRowNumber(), this.getColumnNumber());
};
...
Cell.prototype.getFullAddress = function () {
    return utils.rowAndColumnToAddress(this.getRowNumber(), this.getColumnNumber(), this.getSheet().getName());
};
