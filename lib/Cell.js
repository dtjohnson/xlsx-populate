...
class Cell {
    ...
    formula() {
        ...
        return new ArgHandler('Cell.formula')
            .case(() => {
                ...
                // TODO future: Return translated formula.
     ...
     * @param {string} [replacement] - The text to replace. If pattern is a string, all occurences of the pattern in the cell will be replaced.
     ...
     * @param {...Cell|Range|Group} selections - The selections.
     * @returns {Group} The group.
     */
    groupWith() {
        debug('groupWith(%o)', arguments);
     ...
     * @returns {*} The return value of the callaback.
     */
    thru(callback) {
     ...
     * @param {Cell} cell - The other cell to range to.
     ...
     * @param {string} [formula] - The formula (if the host cell).
    ...
    /**
     * Get the cell's shared formula ID (if set).
