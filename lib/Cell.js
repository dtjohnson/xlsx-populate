...
class Cell {
    ...
    /**
     * Gets the DataValidation attached to the cell.
     * @returns {object|undefined} The DataValidation or undefined if not set.
     *//**
     * Set or clear the DataValidation on the cell.
     * @param {object|undefined} DataValidation - The DataValidation to set or undefined to clear.
     * @returns {Cell} The cell.
     */
    dataValidation() {
