...
class Cell {
     ...
     * @returns {*|Cell} The value of the cell or the cell if setting.
     */
    value(value) {
        if (arguments.length === 0) {
            ...
            let isNode, tNode, vNode, textNode;
            if (typeof value === "string") {
                const stringIndex = this.workbook()._sharedStringsTable.getIndexForString(value);
                this._cellNode.setAttribute("t", "s");
                vNode = this._cellNode.ownerDocument.createElement("v");
                this._cellNode.appendChild(vNode);
                textNode = this._cellNode.ownerDocument.createTextNode(stringIndex);
                ...
                throw new Error("Cell.value: Unsupported value for Cell.value");
            }
        } else {
            throw new Error("Cell.value: Unexpected number of arguments for Cell.value");
        }
