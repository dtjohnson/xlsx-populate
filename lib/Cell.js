...
class Cell {
     ...
     * @return {RichTexts} RichTexts object, you can call add(text, styles).
     */
    toRichText() {
        if (typeof this._value === 'string' && this._value !== '') {
            this._value = new RichTexts().add(this._value, {});
        } else if (!(this._value instanceof RichTexts)) {
            this._value = new RichTexts();
        }
        return this._value;
    }
    ...
    _parseNode(node) {
        ...
        if (type === "s") {
            ...
            if (_.isArray(this._value)) {
                this._value = new RichTexts(this._value);
            }
        } else if (type === "str") {
            // Simple string value.
