...
class Cell {
     ...
     */
    getSharedRefFormula() {
        return this._formulaType === "shared" && this._formulaRef && this._formula;
    }
    ...
    toXml() {
        ...
        const node = {
            name: 'c',
            attributes: this._remainingAttibutes || {}, // Start with any remaining attributes we don't current handle.
            children: []
        };
