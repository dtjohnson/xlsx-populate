...
class Cell {
     ...
     * @param {string|object|undefined} hyperlink - The hyperlink to set or undefined to clear.
     * @param {string} [tooltip] - The tooltip to set for hyperlink.
     * @returns {Cell} The cell.
     */
    hyperlink() {
        return new ArgHandler('Cell.hyperlink')
            ...
            .case(['string', 'string'], (hyperlink, tooltip) => {
                this.sheet().hyperlink(this.address(), hyperlink, tooltip);
                return this;
            })
            ...
            .case('object', obj => {
                this.sheet().hyperlink(this.address(), obj.hyperlink, obj.tooltip);
                return this;
            })
            .handle(arguments);
    }
