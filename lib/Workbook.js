 ...
 * @private
 */
Workbook.prototype._initializeAsync = function (data) {
 ...
 */
Workbook.prototype.outputAsync = function () {
...
Workbook.prototype.toFileAsync = function (path) {
    return this.outputAsync()
        .then(data => fs.writeFileAsync(path, data));
};

Workbook.fromDataAsync = function (data) {
    return new Workbook()._initializeAsync(data);
};

Workbook.fromFileAsync = function (path) {
    return fs.readFileAsync(path)
        .then(data => Workbook.fromDataAsync(data));
};

Workbook.fromBlankAsync = function () {
