            ...
            .then(zip => {
                ...
                return Promise.all([
                    ...
                    this._zip.file("xl/styles.xml").async("string")
                        .then(text => xml2js.parseStringAsync(text, { attrValueProcessors: [xml2js.processors.parseNumbers] })),
                    this._zip.file("xl/workbook.xml").async("string")
                ]);
            })
            .spread((contentTypesNode, relationshipsText, sharedStringsText, styleSheetNode, workbookText) => {
