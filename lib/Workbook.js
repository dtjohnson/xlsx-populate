...
class Workbook {
    ...
    outputAsync(type) {
        ...
        this._zip.file("xl/_rels/workbook.xml.rels", builder.buildObject(this._relationships.toObject()));
        this._zip.file("xl/sharedStrings.xml", builder.buildObject(this._sharedStrings.toObject()));
        this._zip.file("xl/styles.xml", builder.buildObject(this._styleSheet.toObject()));
