...
// TODO: Support sheet, row, and column styles. That will require iterating over all contained styles and updating.
...
class _StyleSheet {
    ...
    createStyle(sourceId) {
        ...
        borderNode.children = [
            _.find(borderNode, ["name", "left"]) || { name: "left", attributes: {}, children: [] },
            _.find(borderNode, ["name", "right"]) || { name: "right", attributes: {}, children: [] },
            _.find(borderNode, ["name", "top"]) || { name: "top", attributes: {}, children: [] },
            _.find(borderNode, ["name", "bottom"]) || { name: "bottom", attributes: {}, children: [] },
            _.find(borderNode, ["name", "diagonal"]) || { name: "diagonal", attributes: {}, children: [] }
        ];
        ...
        return new _Style(this, this._cellXfsNode.children.length - 1, xfNode, fontNode, fillNode, borderNode);
    }
    ...
    _initNode(node) {
        ...
        this._numFmtsNode = _.find(this._node.children, ['name', "numFmts"]);
        this._fontsNode = _.find(this._node.children, ['name', "fonts"]);
        this._fillsNode = _.find(this._node.children, ['name', "fills"]);
        this._bordersNode = _.find(this._node.children, ['name', "borders"]);
        this._cellXfsNode = _.find(this._node.children, ['name', "cellXfs"]);
        ...
        if (!this._numFmtsNode) {
            ...
            jq.insertBefore(this._node.children, this._numFmtsNode, this._fontsNode);
        }
