...
class Row {
    ...
    cell(columnNameOrNumber) {
        ...
        if (!_.isNil(columnStyleId)) styleId = columnStyleId;
        else if (!_.isNil(rowStyleId)) styleId = rowStyleId;
    ...
    style() {
        ...
        return new ArgHandler("Row.style")
            ...
            .case(['string', '*'], (name, value) => {
                ...
                // TODO: If any columns in the sheet have styles, we need to create the cell for that column and this row.
