...
class _ContentTypes {
    ...
    constructor(text) {
        ...
        this._contentTypes = utils.mapChildElements(this._xml.documentElement, node => {
     ...
     * @param {string} partName - The part name.
     * @returns {_ContentType|undefined} The matching content type or undefined if not found.
     */
