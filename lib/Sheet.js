...
class Sheet {
     ...
     * @property {string} activePane Active Pane. The pane that is active.
     ...
     * @param {null|undefined} nil
     * @return {Sheet} The sheet
     *//**
     * Sets sheet view pane options
     * @param {PaneOptions} paneOptions sheet view pane options
     * @return {Sheet} The sheet
     */
    pane() {
     ...
     * @param {number} xSplit (Horizontal Split Position) Horizontal position of the split, 0
     * (zero) if none, this value indicates the number of columns visible in the top pane.
     * @param {number} ySplit (Vertical Split Position) Vertical position of the split, 0
     * (zero) if none, this value indicates the number of rows visible in the left pane.
     * @return {Sheet} The sheet
     *//**
     * freezes Panes for this sheet.
     * @property {string} topLeftCell Top Left Visible Cell. Location of the top left visible cell in the bottom
