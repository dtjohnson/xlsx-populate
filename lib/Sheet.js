...
class Sheet {
     ...
     * @param {string} page - The page of the header.
     ...
     * @param {string} page - The page of the header. See get header for list of valid pages.
     * @param {string|undefined} value - The value to set.
     * @returns {Sheet} This sheet.
     */
    header() {
        const supportedPages = ['odd', 'even', 'first', 'default'];
        const checkPage = this._getCheckAttributeNameHelper('header', supportedPages);
        return new ArgHandler('Sheet.header')
            ...
            .case(['string'], page => {
                checkPage(page);
                page = page === 'default' ? 'odd' : page;
                if (typeof this._headers[page] === 'undefined') {
                    return undefined;
                }
                return this._headers[page].children[0];
            })
            .case(['string', 'nil'], page => {
                checkPage(page);
                page = page === 'default' ? 'odd' : page;
                delete this._headers[page];
            })
            .case(['string', 'string'], (page, value) => {
                checkPage(page);
                page = page === 'default' ? 'odd' : page;                
                if (typeof this._headers[page] === 'undefined') {
                    this._headers[page] = { name: `${page}Header`, children: [] };
                }
                this._headers[page].children[0] = value;
                return this;
            })
            .handle(arguments);
    }
     ...
     * @param {string} page - The page of the footer.
     ...
     * @param {string} page - The page of the footer. See get footer for list of valid pages.
     * @param {string|undefined} value - The value to set.
     * @returns {Sheet} This sheet.
     */
    footer() {
        const supportedPages = ['odd', 'even', 'first', 'default'];
        const checkPage = this._getCheckAttributeNameHelper('footer', supportedPages);
        return new ArgHandler('Sheet.footer')
            ...
            .case(['string'], page => {
                checkPage(page);
                page = page === 'default' ? 'odd' : page;
                if (typeof this._footers[page] === 'undefined') {
                    return undefined;
                }
                return this._footers[page].children[0];
            })
            .case(['string', 'nil'], page => {
                checkPage(page);
                page = page === 'default' ? 'odd' : page;
                delete this._footers[page];
            })
            .case(['string', 'string'], (page, value) => {
                checkPage(page);
                page = page === 'default' ? 'odd' : page;                
                if (typeof this._footers[page] === 'undefined') {
                    this._footers[page] = { name: `${page}footer`, children: [] };
                }
                this._footers[page].children[0] = value;
                return this;
            })
            .handle(arguments);
    }
