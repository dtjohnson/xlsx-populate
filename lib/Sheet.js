...
class Sheet {
    ...
    /**
     * Get a value whether the cells in the given address have dataValidation.
     * @param {string} address - The address to check.
     * @returns {object|undefined} Datavalidation or undefined if not set
     * @ignore
     *//**
     * add dataValidation to cells at the given address if object is an object and not null, remove if null
     * @param {string} address - The address to merge.
     * @param {object} obj - Object to set, false to delete.
     * @returns {Sheet} The sheet.
     */
    dataValidation() {
        return new ArgHandler('Sheet.dataValidation')
            .case('string', (address) => {
                return this._dataValidations[address];
            })
