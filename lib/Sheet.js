...
class Sheet {
     ...
     * @ignore
     *//**
     * Add dataValidation to cells at the given address if object or string and not null, remove if null
     * @param {string} address - The address to set.
     * @param {object|string} obj - Object or String to set, null to delete.
     * @returns {Sheet} The sheet.
     * @ignore
     */
    dataValidation() {
