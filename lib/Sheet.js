...
class Sheet {
     ...
     * @param {string} address - The address of the hyperlinked cell.
     * @param {string} hyperlink - The hyperlink to set.
     * @param {{}}} opts - Options.
    ...
    hyperlink() {
        return new ArgHandler('Sheet.hyperlink')
            ...
            .case(['string', 'string'], (address, hyperlink) => {
                return this.hyperlink(address, { hyperlink: hyperlink });
            })
            .case(['string', 'string', 'object'], (address, hyperlink, opts) => {
                ...
                if (opts.tooltip) {
                    hyperlinkAttributes.tooltip = tooltip;
                }
