    ...
    column(columnNameOrNumber) {
        ...
        if (existingColNode) {
            ...
            if (existingColNode.attributes.min < columnNumber) {
                ...
                // Insert it before the existing node so it's in the right place and update the col nodes cache.
            ...
            // Make a clone for the new column. Set the min/max to the column number and insert.
