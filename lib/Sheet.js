...
class Sheet {
     ...
     * @ignore
     *//**
     * Set the hyperlink attached to the cell with the given email and subject.
     * @param {string} address - The address to of the hyperlinked cell.
     * @param {string} email - The email address to set.
     * @param {string} subject - The email subject to set.
     * @returns {Sheet} The sheet.
     * @ignore
     */
    hyperlink() {
        return new ArgHandler('Sheet.hyperlink')
            ...
            .case(['string', 'string'], (address, hyperlink) => {
                var hyperlinkAttributes;
                const isHyperlinkInternalAddress = addressConverter.fromAddress(hyperlink);
            ...
            .case(['string', 'string', 'string'], (address, email, subject) => {
                const hyperlink = encodeURI('mailto:' + email + '?' + 'subject=' + subject);
