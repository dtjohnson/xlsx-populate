...
class ArgHandler {
    ...
    _argsMatchTypes(args, types) {
        ...
        return _.every(args, (arg, i) => {
            ...
            // The require is down here to avoid a potential circular dependancy issue
            if (type === 'Style') return arg && arg.constructor === require("./Style"); // eslint-disable-line global-require
