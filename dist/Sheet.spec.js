...
describe("Sheet", () => {
    ...
    describe("pageMarginsPreset", () => {
        ...
        it("should throw an error if accessing non-existing presets", () => {
            expect(() => sheet.pageMarginsPreset('NOT_A_PRESET_NAME')).toThrowError(Error, 'Sheet.pageMarginsPreset: "NOT_A_PRESET_NAME" is not supported.');
        });
        it("should throw an error if a preset is defined without all necessary attributes", () => {
            expect(() => sheet.pageMarginsPreset('my_preset', { left: 123 })).toThrowError(Error, 'Sheet.pageMarginsPreset: Invalid preset attributes for one or key(s)! - "left"');
        });
    });
    ...
    describe("_init", () => {
        ...
        it("should create the sheetPr node", () => {
            ...
            expect(sheet._sheetPrNode).toEqual({ name: 'sheetPr', attributes: {}, children: [] });
        });
