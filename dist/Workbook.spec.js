...
describe("Workbook", () => {
    ...
    beforeEach(() => {
        ...
        spyOn(XmlParser.prototype, "parseAsync").and.callFake(text => Promise.resolve(`JSON(${text})`));
        // XmlParser = { XmlParser: jasmine.createSpy("XmlParser") };
        // XmlParser.XmlParser.prototype.parseAsync = jasmine.createSpy("XmlParser.parseAsync").and.callFake(text => Promise.resolve(`JSON(${text})`));
    ...
    describe("static", () => {
        beforeEach(() => {
            spyOn(Workbook.prototype, "_init").and.returnValue(Promise.resolve("WORKBOOK"));
        });
        ...
        describe("fromDataAsync", () => {
            it("should init with the data", () => {
                return Workbook.fromDataAsync("DATA", "OPTS")
                    .then(workbook => {
                    expect(Workbook.prototype._init).toHaveBeenCalledWith("DATA", "OPTS");
                    expect(workbook).toBe("WORKBOOK");
                });
            });
        });
...
//# sourceMappingURL=Workbook.spec.js.map