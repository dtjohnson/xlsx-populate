...
const ContentTypes = require("./ContentTypes").ContentTypes;
const AppProperties = require("./AppProperties").AppProperties;
const CoreProperties = require("./CoreProperties");
const Relationships = require("./Relationships").Relationships;
const SharedStrings = require("./SharedStrings").SharedStrings;
...
class Workbook {
    ...
    static fromDataAsync(data, opts) {
        return new Workbook()._init(data, opts);
    }
    /**
