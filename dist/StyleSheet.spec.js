...
describe("StyleSheet", () => {
    ...
    beforeEach(() => {
        ...
        StyleSheet = proxyquire("./StyleSheet", {
            "./Style": Style,
            '@noCallThru': true
        });
        styleSheetNode = {
    ...
    describe("createStyle", () => {
        it("should clone an existing style", () => {
            ...
            expect(Style).toHaveBeenCalledWith(styleSheet, 1, styleSheet._cellXfsNode.children[1], styleSheet._fontsNode.children[0], styleSheet._fillsNode.children[0], styleSheet._bordersNode.children[1]);
        });
