import { ArgHandler, Handler } from '../../src/ArgHandler';

describe('ArgHandler', () => {
    let argHandler: ArgHandler;
    let handlers: { [name: string]: Handler };
    ...
    describe('handle', () => {
        ...
        it('should handle Styles', () => {
            ...
            expect(argHandler.handle([ someInstance ])).toBe('SomeClass');
