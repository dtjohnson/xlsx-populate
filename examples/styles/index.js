...
Workbook.fromBlankAsync("./row col size.xlsx")
    .then(workbook => {
        ...
        // console.log(JSON.stringify(sheet.cell("A22").value("top border").style().topBorderStyle("thin").topBorderStyle()));
        // console.log(JSON.stringify(sheet.cell("A23").value("left border").style().leftBorderStyle("thin").topBorderStyle()));
        // console.log(JSON.stringify(sheet.cell("A24").value("right border").style().rightBorderStyle("thin").topBorderStyle()));
        // console.log(JSON.stringify(sheet.cell("A25").value("bottom border").style().bottomBorderStyle("thin").topBorderStyle()));
        // console.log(JSON.stringify(sheet.cell("A26").value("double bottom border").style().bottomBorderStyle("double").topBorderStyle()));
        // console.log(JSON.stringify(sheet.cell("A27").value("medium bottom border").style().bottomBorderStyle("medium").topBorderStyle()));
        // console.log(JSON.stringify(sheet.cell("A28").value("thick bottom border").style().bottomBorderStyle("thick").topBorderStyle()));
